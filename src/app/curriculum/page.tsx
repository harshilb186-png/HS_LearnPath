              ...
              <Card className="glass-card p-8 rounded-[2rem] border-white/5 min-w-[320px]">
                <div className="flex items-center gap-8">
                  ...
                  <div className="space-y-2">
                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary/70">Milestones</p>
        ...
        <div className="grid grid-cols-1 gap-8">
          {isPathsLoading ? (
            ...
            learningPaths.map((path, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row items-stretch">
                  <div className="md:w-32 flex items-center justify-center p-8 border-b md:border-b-0 md:border-r border-white/5 bg-primary/10 transition-colors group-hover:bg-primary/20">
                    <div className="text-4xl font-headline font-black text-primary opacity-50 group-hover:opacity-100 transition-opacity">
                  ...
                  <div className="flex-1 p-10 space-y-8">
                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8">
                      <div className="space-y-4 max-w-3xl">
                        <div className="flex items-center gap-4">
                          <div className="bg-primary/20 p-2 rounded-xl group-hover:scale-110 transition-transform"><PlayCircle className="h-6 w-6 text-primary" /></div>
                      ...
                      <div className="flex flex-col items-end gap-3 shrink-0">
                        ...
                        <span className="text-sm font-bold text-muted-foreground flex items-center gap-3">
                          <Clock className="w-4 h-4 text-primary" /> Self-Paced Access
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-10 border-t border-white/5">
                      <div className="flex gap-4">
                        <Badge variant="outline" className="bg-white/5 border-white/5 text-[10px] uppercase font-bold tracking-[0.25em] py-2 px-5 rounded-full text-muted-foreground">
                          <Sparkles className="w-3.5 h-3.5 mr-2 text-primary" /> AI Assisted
                        </Badge>
                        <Badge variant="outline" className="bg-white/5 border-white/5 text-[10px] uppercase font-bold tracking-[0.25em] py-2 px-5 rounded-full text-muted-foreground">
                          <BookOpen className="w-3.5 h-3.5 mr-2 text-primary" /> Project Focused
                        </Badge>
                      </div>
            ...
            <div className="text-center py-32 glass-card rounded-[3rem] border-dashed border-white/10">
              <BookOpen className="h-20 w-20 text-muted-foreground mx-auto mb-8 opacity-20" />
              ...
              {isStaff && (
                <Button asChild variant="outline" className="cyber-button rounded-full h-14 px-12 border-white/10 hover:bg-white/5 font-bold text-lg">
